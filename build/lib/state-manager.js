...
class StateManager {
  ...
  async refreshInstanceObjects() {
    await this.adapter.extendObject("info", {
      common: { name: (0, import_i18n.tName)("channelInfo"), desc: (0, import_i18n.tDesc)("descChannelInfo") }
    });
    await this.adapter.extendObject("info.connection", {
      common: { name: (0, import_i18n.tName)("connectionStatus"), desc: (0, import_i18n.tDesc)("descConnectionStatus") }
    });
    await this.adapter.extendObject("info.upsTotal", {
      common: { name: (0, import_i18n.tName)("upsCountTotal"), desc: (0, import_i18n.tDesc)("descUpsCountTotal") }
    });
    await this.adapter.extendObject("info.upsReachable", {
      common: { name: (0, import_i18n.tName)("upsCountReachable"), desc: (0, import_i18n.tDesc)("descUpsCountReachable") }
    });
    await this.adapter.extendObject("info.allUpsReachable", {
      common: { name: (0, import_i18n.tName)("upsAllReachable"), desc: (0, import_i18n.tDesc)("descUpsAllReachable") }
    });
    await this.adapter.extendObject("notify", {
      common: { name: (0, import_i18n.tName)("notifyTrigger"), desc: (0, import_i18n.tDesc)("descNotifyTrigger") }
    });
  }
  /**
  ...
  dropCacheUnder(prefix) {
    const under = (id) => id === prefix || id.startsWith(`${prefix}.`);
